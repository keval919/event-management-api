...
routes.route("/get-event/:id").get(event.getEventData)                 //fetch event data by id
routes.route("/event-stats/:id").get(event.eventStats)                 //get event statics like total,remaining and percentage of registration capacity
routes.route("/cancel-registration/:event_id").delete(registration.cancelRegistration)       //cancel registration
